...
TOKEN = '7434115768:AAEXIbVy7wm7L006FLKCls70Pv7ziUVpEmY'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002208206886
CHANNEL_ID = -1002208206886
error_channel_id = -1002208206886
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/DDOS_BGMI*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@aoscheatt*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@Aos_cheat_bot*", parse_mode='Markdown')
    else:
